  ...
  if (wishlist.length === 0) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-20 mt-20 text-center">
        ...
        <p className="text-slate-400 mb-8">Save items you love by clicking the heart icon on any product</p>
    ...
    <div className="max-w-4xl mx-auto px-4 py-20 mt-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {wishlist.map((product) => (
          <div key={product._id} className="border border-slate-100 bg-white">
            ...
            <div className="p-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 bg-[#001F3F] text-white py-2 text-xs uppercase tracking-widest flex items-center justify-center gap-2"
                >
                  <ShoppingBag size={14} />
                  Add to Cart
                </button>
                <button
                  ...
                  className="p-2 border border-slate-200 text-slate-400 hover:text-red-500"
                >
                  <Trash2 size={16} />
                </button>
              </div>
